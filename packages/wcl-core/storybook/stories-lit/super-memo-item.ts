...
export const SuperMemoItemStories: SuperMemoItemStoriesBuilder<
  Meta,
  Story<SuperMemoItemStoryAttrs>
> = (compInfo, template) => {
  ...
  return {
    Default,
    LongMemo,
    componentMeta: SuperMemoItemMeta(compInfo),
  };
};
