...
export function onDoSomethingWithTitle() {
  if (memoTitle) {
    const memo = {
...
export function onMemoDeleted(ev) {
  const memoId = ev.detail.memoId;
 ...
 * component
 */
export function onMemoAdded(ev) {
